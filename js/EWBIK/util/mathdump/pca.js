 ...
 * @returns 
 */
export function  computeDeviationMatrix(matrix) {
 ...
 * @returns 
 */
export function  computeDeviationScores(deviation) {
 ...
 * @returns 
 */
export function  computeVarianceCovariance(devSumOfSquares, sample) {
 ...
 * @returns 
 */
export function  computeAdjustedData(data, ...vectorObjs) {
 ...
 */
export function  computeOriginalData(adjustedData, vectors, avgData) {
 ...
 * @param {*} selected 
 */
export function  computePercentageExplained(vectors, ...selected) {
...
export function  formatData(data, precision) {
 ...
 * @returns 
 */
export function  scale(matrix, factor) {
    var result = [];
 ...
 */
export function  unitSquareMatrix(rows) {
    var result = [];

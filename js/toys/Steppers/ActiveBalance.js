...
export class ActiveBalance {
    ...
    update(doWalkery) {
        ...
        if(doWalkery) {
            ...
            maybeRebalance(); //determine if a foot should move for better balance
            maybeStep(); //determine best foot to unplant to continue locomotion
            maybeStride(); //if a foot has been unplanted, determine where it aims to land
            maybePlant(); //if a foot has exceeded its stride time or cone, ensure it gets planted 
        }
        this.ensureHipClearance(1);
